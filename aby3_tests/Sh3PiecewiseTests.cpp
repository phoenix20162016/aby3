...
void Sh3_Piecewise_plain_test(const oc::CLP& cmd)
{
	u64 dec = 16;
	u64 n = 64;
...
void Sh3_Piecewise_test(const oc::CLP& cmd)
{
	...
	auto e02 = Session(ios, "127.0.0.1:1313", SessionMode::Server, "02");
	auto e20 = Session(ios, "127.0.0.1:1313", SessionMode::Client, "02");
	...
	auto chl12 = e12.addChannel(); auto dchl12 = e12.addChannel();
	auto chl21 = e21.addChannel(); auto dchl21 = e21.addChannel();

	CommPkg comms[3], dcomms[3];
	comms[0] = { chl02, chl01 }; dcomms[0] = { dchl02, dchl01 };
	comms[1] = { chl10, chl12 }; dcomms[1] = { dchl10, dchl12 };
	comms[2] = { chl21, chl20 }; dcomms[2] = { dchl21, dchl20 };
